...
import FM_epy_block_0_0 as epy_block_0_0  # embedded python block
import FM_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading
...
class FM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM Audio modulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Audio modulation")
        ...
        self.epy_block_1 = epy_block_1.blk(filename="output", num_samples=2048, modulation_scheme="FM", snr=SNR, freq_offset=freq_offset, max_files=100)
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=False)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/Users/eez096/Desktop/rf-channel-simulator/Audio_Recording/767102__audiomirage__strange-language.wav', True)
