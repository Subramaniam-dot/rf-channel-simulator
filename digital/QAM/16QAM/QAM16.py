...
import QAM16_epy_block_0_0 as epy_block_0_0  # embedded python block
import QAM16_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading
...
class QAM16(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "16_QAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("16_QAM")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QAM16")
        ...
        self.filename = filename = "QAM_16"
        self.QAM_16 = QAM_16 = digital.constellation_16qam().base()
        self.QAM_16.set_npwr(0.000)
        self.M = M = 16
        ...
        self.epy_block_1 = epy_block_1.blk(filename="output", num_samples=2048, modulation_scheme="16QAM", snr=SNR, freq_offset=freq_offset, max_files=100)
