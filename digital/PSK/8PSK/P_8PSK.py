...
import P_8PSK_epy_block_0_0 as epy_block_0_0  # embedded python block
import P_8PSK_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class P_8PSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "P_8PSK")
        ...
        self.p_8psk = p_8psk = digital.constellation_8psk().base()
        self.p_8psk.set_npwr(0.000)
        ...
        self.epy_block_1 = epy_block_1.blk(filename="output", num_samples=2048, modulation_scheme="8PSK", snr=SNR, freq_offset=freq_offset, max_files=100)
        self.epy_block_0_0 = epy_block_0_0.blk(min_val=freq_off_min, max_val=freq_off_max)
        self.digital_constellation_modulator_0 = digital.generic_mod(
            constellation=p_8psk,
            differential=True,
...
def main(top_block_cls=P_8PSK, options=None):
