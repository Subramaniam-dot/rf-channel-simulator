...
import QPSK_epy_block_0_0 as epy_block_0_0  # embedded python block
import QPSK_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading
...
class QPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1 = epy_block_1.blk(filename="output", num_samples=2048, modulation_scheme="QPSK", snr=SNR, freq_offset=freq_offset, max_files=100)
