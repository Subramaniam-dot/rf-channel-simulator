...
import FSK_8_epy_block_0 as epy_block_0  # embedded python block
import sip



class FSK_8(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FSK_8")
...
def main(top_block_cls=FSK_8, options=None):
